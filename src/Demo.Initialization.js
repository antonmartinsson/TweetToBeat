...
//    *
//    * Example code:
//    *   Demo.playTrack("spotify:track:1oe9xO03mgCcEW19IXOKgO")
//    */
    playTrack: (uri) => {
    ...
    getTweetTrack: (twitterHandle) => {
      let request = new Request("https://tweettobeatserver.glitch.me/tweets.json?twitterhandle=" + twitterHandle, {
        method: "GET",
      });
